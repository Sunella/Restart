...
<div id="video-container" class="" itemscope itemid=""
	...
	<div itemprop="aggregateRating" itemscope
		...
		<meta itemprop="ratingCount"
			content="<?php echo $this->commentview[0]->ratecount; ?>" />
	</div>
	...
	<meta itemprop="embedURL"
		content="<?php echo $playerpath . '?id=' . $this->videodetails->id; ?>" />
</div>
...
<div class="fluid bg playerbg clearfix" id="player_page">
	<div id="HDVideoshare1" style="position: relative;" class="clearfix">
			...
			if ($this->homepageaccess == 'true') {
				if ($htmlVideoDetails->filepath == 'Embed') {
					...
					if ($mobile === true) {
						...
						echo str_replace ( 'height=', 'height="' . $player_values ['height'] . '"', $playeriframewidth );
						?>
						</div>
						<?php
					}
		...
		<?php
				...
				<style type="text/css">
.login_msg {
	height: <?php echo $player_values['height']; ?> px;
	color: #fff;
	width: 100%;
		...
		<div id="htmlplayer">
				...
				if ($this->homepageaccess == 'true') {
					...
					if ($htmlVideoDetails->filepath == "Youtube" || strpos ( $htmlVideoDetails->videourl, 'youtube.com' ) > 0) {
						...
						if (strpos ( $htmlVideoDetails->videourl, 'youtube.com' ) > 0) {
							...
							?>
								<iframe width="<?php echo $player_values['width']; ?>"
				height="<?php
				...
				class="iframe_frameborder"></iframe>
					<?php
							...
							?>
								<iframe id="viddler-<?php echo $imgstr; ?>"
				src="//www.viddler.com/embed/<?php
							echo $imgstr;
				...
				height="<?php
							echo $player_values ['height'];
							?>"
				frameborder="0" mozallowfullscreen="true"
