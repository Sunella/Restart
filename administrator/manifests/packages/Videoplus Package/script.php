...
class Pkg_VideoplusPackageInstallerScript
{
	...
	function postflight($type, $parent)
	{
		...
		JFile::move(
				$root . DS . 'templates' . DS . 'videoplus' . DS . 'templateDetails.j3.xml',
				$root . DS . 'templates' . DS . 'videoplus' . DS . 'templateDetails.xml');
		...
		echo '<p style="font-style:normal;font-size:13px;font-weight:normal; margin-top:10px;margin-left:10px;">Videoplus</p>
			...
			<p> Template Videoplus Installed Successfully</p>
			<br/>';
	}
}
